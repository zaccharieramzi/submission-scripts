...
loss = 'compound_mssim'
batch_size = 32
lr = 1e-4 if batch_size is None else batch_size * 1e-4 / 4
n_samples = None
n_epochs = 500
n_primal = 5
contrast = None
...
parameter_grid = [
    ...
    dict(
        ...
        af=4,
        loss=loss,
        lr=lr,  # needed here to avoid nans
        mask_type='random',
        n_dual=n_dual,
        n_iter=n_iter,
        primal_only=primal_only,
...
# run_ids = [
#     'xpdnet_sense__af8_i35_compound_mssim_rf_sm_MWCNNmedium_1612714389',
#     'xpdnet_sense__af4_i35_compound_mssim_rf_sm_MWCNNmedium_1612714390',
# ]
