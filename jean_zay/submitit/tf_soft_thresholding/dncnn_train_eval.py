...
models = {
    ...
    'dncnn-st': {'activation': 'soft_thresh', 'st_kwargs': {'threshold': 0.2}},
    'dncnn-nc-relu': {'naive_noise_conditioning': True, },
    'dncnn-nc-prelu': {'naive_noise_conditioning': True, 'activation': 'prelu'},
    'dncnn-nc-st': {'naive_noise_conditioning': True, 'activation': 'soft_thresh', 'st_kwargs': {'threshold': 0.2}},
    'dncnn-dst': {'activation': 'dynamic_soft_thresh', 'st_kwargs': {'alpha_init': 0.2}},
    'dncnn-dst-train': {'activation': 'dynamic_soft_thresh', 'st_kwargs': {'alpha_init': 0.2, 'trainable': True}},
    'dncnn-dst-train-per-fiter': {'activation': 'dynamic_soft_thresh', 'st_kwargs': {'alpha_init': 0.2, 'trainable': True, 'per_filter': True}},
    'dncnn-dst-train-per-filter-w-noise-est': {'activation': 'dynamic_soft_thresh', 'st_kwargs': {'alpha_init': 0.2, 'trainable': True, 'per_filter': True, 'noise_estimation': True}},
    'dncnn-dst-train-w-noise-est': {'activation': 'dynamic_soft_thresh', 'st_kwargs': {'alpha_init': 0.2, 'trainable': True, 'noise_estimation': True}},
}
parameter_grid = [
    dict(
